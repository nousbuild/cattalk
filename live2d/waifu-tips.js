...
function loadWidget(config) {
	...
	document.body.insertAdjacentHTML("beforeend", `<div id="waifu">
			...
			<div id="waifu-tool">
				<span class="icon-spinner6" style="font-size: 22px;"></span>
				<span class="icon-cross" style="font-size: 16px;"></span>
			</div>
		</div>`);
	setTimeout(() => {
	...
	(function registerEventListener() {
		document.querySelector("#waifu-tool .icon-spinner6").addEventListener("click", loadRandModel);
		document.querySelector("#waifu-tool .icon-cross").addEventListener("click", () => {
		...
		devtools.toString = () => {
			showMessage("惊！控制打开了，是想要看看我的小秘密吗？！", 6000, 9);
		};
	...
	(function welcomeMessage() {
		...
		if (location.pathname === "/") { // 如果是主页
			...
			if (location.hostname === referrer.hostname) text = `哎鸭！终于等到你了来<span>小喵心语</span>串门了，你也是喜欢看漫画吧？`;
		} else {
			text = `哎鸭！终于等到你了来<span>小喵心语</span>串门了，你也是喜欢看漫画吧？`;
		}
